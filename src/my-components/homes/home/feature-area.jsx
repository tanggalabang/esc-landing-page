...
const feature_data = [
  {
    ...
    description: (
      <>
        e-SchoolConnect provides easy access to the learning materials required
        by students. Students can access learning materials, assignments and
        exams from anywhere and at any time through the platform.
      </>
    ),
    delay: ".4s",
  },
  {
    ...
    description: (
      <>
        e-SchoolConnect allows students to interact with teachers and
        classmates. Students can ask questions, discuss and share ideas with
        teachers and classmates through live comments.
      </>
    ),
    delay: ".6s",
  },
  {
    ...
    description: (
      <>
        e-SchoolConnect provides classroom management features that are easy for
        teachers to use. Teachers can easily and manage materials and
            ...
            {feature_data.map((item, i) => (
              ...
              >
                <div id="divtest" className="tp-feature__item">
                  ...
                  <p style={{ lineHeight: "25px" }}>{item.description}</p>
